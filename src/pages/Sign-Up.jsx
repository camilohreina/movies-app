...
export default function SignUp() {
    ...
    return (<>
        <BackButton />
    <form onSubmit = {(e) =>handleSubmit(e)} className="flex justify-center items-center h-full">
        <div className= "flex flex-col justify-center items-center m-1 p-8 border-2 border-gray-700 rounded ">
            <h1 className="text-white text-3xl font-bold text-center w-full" > Sign Up </h1>
